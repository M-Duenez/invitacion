  ...
  return (
    ...
    >
      ...
      <div className="relative flex justify-center ">
        ...
        <div className="absolute inset-0 flex flex-col w-full items-center justify-end mb-10 md:mb-13 pointer-events-none">
          <h1 className="text-4xl md:text-6xl text-gold-500 titulo">
            {nombre}
          </h1>
